...
const MOCK_DATA: Order[] = [
    { id: '#ORD-2026-101', product: 'Office Furniture Set', customer: 'Alice Smith', customerCompany: 'OFFICE DEPOT', items: '12 Items', total: 'USD 5,400.00', status: 'Processing', date: 'Jan 22, 2026' },
    { id: '#ORD-2026-102', product: 'Laptops - Batch X1', customer: 'Bob Jones', customerCompany: 'TECH CORP', items: '50 Units', total: 'USD 45,000.00', status: 'Pending', date: 'Jan 21, 2026' },
    { id: '#ORD-2026-103', product: 'Networking Cables', customer: 'Charlie Day', customerCompany: 'NET SYSTEMS', items: '500 Meters', total: 'USD 2,100.00', status: 'Delivered', date: 'Jan 21, 2026' },
    { id: '#ORD-2026-104', product: 'Server Rack 42U', customer: 'Dana White', customerCompany: 'DATA CENTER INC', items: '2 Units', total: 'USD 8,200.00', status: 'Cancelled', date: 'Jan 20, 2026' },
];

const groupData = (data: Order[]) => {
...
const getStatusColor = (status: string) => {
    switch (status) {
        case 'Processing': return { bg: '#3B82F6', text: '#FFFFFF' }; // Blue
...
const OrdersScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
        ...
        return (
            ...
            >
                ...
                <View style={styles.cardHeader}>
                    <View style={styles.headerLeft}>
                        ...
                        <View style={[styles.iconBox, { backgroundColor: theme.primaryLight + '20' }]}>
                            <MaterialCommunityIcons name="clipboard-list" size={18} color={theme.primaryLight} />
                        </View>
                ...
                <View style={[styles.detailsRow, { borderTopColor: theme.borderLight }]}>
                    ...
                    <View style={styles.detailItem}>
                        <Text style={[styles.detailLabel, { color: theme.textTertiary }]}>Customer</Text>
    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
                ...
                {!isSearchExpanded ? (
                    <>
                        <View style={styles.headerLeftContainer}>
                            ...
                            <Text style={[styles.headerTitle, { color: theme.headerText }]}>Orders</Text>
                        </View>
                        ...
                        <View style={styles.headerRight}>
                            ...
                            <TouchableOpacity
                                onPress={() => navigation.navigate('GenericForm', { title: 'Order' })}
            ...
            {/* Removed Logout/User Icon Popup */}
        </SafeAreaView>
    );
};
